...
if(!function_exists('thethe_wp_rss')){
	include_once ABSPATH . WPINC . '/rss.php';	
	function thethe_wp_rss( $url, $num_items = -1 ) {
		$rss = fetch_rss( $url );
		if ( $rss ) {
			echo '<ul>';
			if ( $num_items !== -1 ) {
            ...
            <div id='post-body'>
              <div id='post-body-content'>
                <div class="screenshot-wrap">
                  <div class="inner">
                    <div class='screenshot'><a href="http://thethefly.com/" title="TheTheFly.Com" target="_blank"><img src="<?php echo $GLOBALS['TheTheTS']['wp_plugin_dir_url'];?>style/admin/images/thethefly.jpg" /></a></div>
                  </div>
                </div>
                <div class="info">
                ...
                <div class="thethefly-latest-news">
                  <h4>From the News:</h4>
                  <?php thethe_wp_rss('http://news.thethefly.com/category/latest/feed/', 5);?>
                </div>
              </div>
              <!-- /#post-body-content --> 
            </div>
