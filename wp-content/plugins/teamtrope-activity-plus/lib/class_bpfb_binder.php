...
class BpfbBinder {
	...
	function js_load_scripts () {
		...
		wp_localize_script('bpfb_interface_script', 'l10nBpfb', array(
			'add_photos' => __('Add photo, doc, pdf', 'bpfb'),
			...
			'images_limit_exceeded' => sprintf(__("You tried to add too many, only %d will be posted.", 'bpfb'), BPFB_IMAGE_LIMIT),
			// Variables
	...
	function ajax_preview_photo () {
		...
		$uploader = new qqFileUploader(array('jpg', 'jpeg', 'gif', 'doc','docx','pdf'));
