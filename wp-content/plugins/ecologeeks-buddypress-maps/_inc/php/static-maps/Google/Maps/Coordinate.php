...
require_once BP_MAPS_PLUGIN_DIR . '/_inc/php/static-maps/Google/Maps/Location.php';
require_once BP_MAPS_PLUGIN_DIR . '/_inc/php/static-maps/Google/Maps/Mercator.php';
