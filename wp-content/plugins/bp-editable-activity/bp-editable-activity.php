...
class BP_Editable_Activity_Helper{
    ...
    public function edit_activity_comment_btn(){
        ...
        $data = bp_get_activity_comment_content();
         
        $edit_label = __( 'Edit', 'bp-editable-activity' );
       
        $btn = "<a href='#' class='acomment-reply-edit bp-primary-action' id='acomment-reply-edit-" . $activity_id . "' data-type='textarea' data-value='" . esc_attr( $data ) . "' data-id='" . $activity_id . "'>{$edit_label}</a>";
