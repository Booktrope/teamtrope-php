	...
	jQuery(document).ready('table').floatThead();
		...
		<div class="page-title-wrap">
			<div class="container clearfix">
        		<h1 class="page-title">The Grid - All Book Projects</h1>
    			<!-- .page-title --> 
  			</div>
		</div>
		<div id="content">
...
$headers = array("Title", "Days in Step", "Author","Genre","Original Manuscript","Update","Status","by","on","Teamroom Link","Workflow Step","ISBN",
                 "eBook ISBN","ASIN","LSI ISBN","Project Manager","Editor","Proofreader",
                 "Marketing Manager","Cover Designer","Edit Complete Date","Author Pct",
...
<table id="Table<?php echo $i; ?>" class="sortable" style="display: none;">
   <tr>
   <?php 
...
<?php 
 ...
 ?>
 	<tr>
		...
		<td><?php echo daysInStatus( $post, false, $custom_fields['book_pcr_step'][0] );?></td>
