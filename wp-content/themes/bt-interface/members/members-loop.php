...
<?php if ( bp_has_members( 'per_page=21', bp_ajax_querystring( 'members' ) ) ) : ?>
		...
		<li>
			...
			<div class="item">
				<div class="item-title">
					...
					<?php echo bp_member_profile_data('field=Role(s)'); ?><br/>
				</div>
				<div class="item-meta">
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( "Sorry, no members were found.", 'studio' ); ?></p>
	</div>
