		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php if ( !bp_get_the_thread_recipients() ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'studio' ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'studio' ), bp_get_the_thread_recipients() ) ?>

				<?php endif; ?>

			</span>

			<a class="button confirm" href="<?php bp_the_thread_delete_link() ?>" title="<?php _e( "Delete Message", "buddypress" ); ?>"><?php _e( 'Delete', 'studio' ) ?></a> &nbsp;
		</p>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'studio' ) ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php _e( 'Send Reply', 'studio' ) ?>" id="send_reply_button"/>
					</div>
