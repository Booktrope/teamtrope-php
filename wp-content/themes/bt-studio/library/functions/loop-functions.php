...
function bp_wpmu_blogpage_loop(){
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="post-content">
				...
				<p class="date"><?php the_date() ?> <em><?php _e( 'in', 'studio' ) ?> <?php the_category(', ') ?> <?php _e( 'by ', 'studio' ) ?><?php the_author_link();  ?></em></p>
				<div class="entry">
...
function wpmu_blogpage_loop(){
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="post-content-wp">
				<h2 class="posttitle"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e( 'Permanent Link to', 'studio' ) ?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
					<p class="date"><span class="byline"><?php the_date() ?> <?php _e( 'in', 'studio' ) ?> <?php the_category(', ') ?> <em><?php _e( 'by ', 'studio' ) ?><?php the_author_link();  ?></em></span></p>
						<div class="entry">
									<a href="<?php the_permalink() ?>">
										<?php if(function_exists('the_post_thumbnail')) { ?><?php if(get_the_post_thumbnail() != "") { ?><div class="alignleft">
										<?php the_post_thumbnail(); ?></div><?php } } ?>
		...
		while (have_posts()) : the_post(); ?>
			<div class="post" id="post-<?php the_ID(); ?>">
				...
				<div class="post-content">
					...
					<p class="date"><?php the_date() ?> <em><?php _e( 'in', 'studio' ) ?> <?php the_category(', ') ?> <?php _e( 'by ', 'studio' ) ?><?php the_author_link();  ?></em></p>
					<div class="entry">
						<?php the_content( __( 'Read the rest of this entry &rarr;', 'studio' ) ); ?>
					</div>
					<p class="postmetadata"><span class="tags"><?php the_tags( __( 'Tags: ', 'studio' ), ', ', '<br />'); ?></span> <span class="comments"><?php comments_popup_link( __( 'No Comments &#187;', 'studio' ), __( '1 Comment &#187;', 'studio' ), __( '% Comments &#187;', 'studio' ) ); ?></span></p>
				</div>
			</div>
...
function bp_wpmu_page_loop(){
		...
		while (have_posts()) : the_post(); ?>
			...
			<div class="post" id="post-<?php the_ID(); ?>">
				<div class="entry">
					<?php the_content( __( '<p class="serif">Read the rest of this page &rarr;</p>', 'studio' ) ); ?>
					<?php wp_link_pages( array( 'before' => __( '<p><strong>Pages:</strong> ', 'studio' ), 'after' => '</p>', 'next_or_number' => 'number')); ?>
					<?php edit_post_link( __( 'Edit this entry.', 'studio' ), '<p>', '</p>'); ?>
				</div>
			</div>
			...
			$_post = &get_post($post->ID); $classname = ($_post->iconsize[0] <= 128 ? 'small' : '') . 'attachment'; // This lets us style narrow icons specially ?>
				...
				<div class="post" id="post-<?php the_ID(); ?>">
					...
					<div class="entry">
						...
						<?php the_content( __('<p class="serif">Read the rest of this entry &rarr;</p>', 'studio' ) ); ?>
