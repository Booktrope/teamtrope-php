<form action="<?php bp_messages_form_action('compose') ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'studio') ?></label>
	...
	<label for="subject"><?php _e( 'Subject', 'studio') ?></label>
	<input type="text" name="subject" id="subject" value="<?php bp_messages_subject_value() ?>" />

	<label for="content"><?php _e( 'Message', 'studio') ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php _e( "Send Message", 'studio' ) ?>" name="send" id="send" />
	</div>
