					...
					<div class="tabs"> <!-- wrapper for Complete Manuscript -->
						...
						<div id="tabs-305">
							...
							echo do_shortcode('[gravityform id="16" name="Upload Final Document" ajax="true"]'); 
                                                        echo do_shortcode('[directory form="12" search="false" entry="false" entryonly="false" entryanchor="false" lightboxsettings="images,entry" showcount="false" thead="false" showrowids="false" jssearch="false" linkemail="false" linknewwindow="true" nofollowlinks="true" credit="false"]'); 
                                                        ?>
							...
							echo do_shortcode('[gravityform id="12" name="Approve Final Document for Print" ajax="true"]'); 
                                                        echo do_shortcode('[directory form="16" search="false" entry="false" entryonly="false" entryanchor="false" lightboxsettings="images,entry" showcount="false" thead="false" showrowids="false" jssearch="false" linkemail="false" linknewwindow="true" nofollowlinks="true" credit="false"]'); 
                                                        ?>
                                                        <br/>
				...
				<div id="tabs-4"> <!-- Produce book -->
					...
					<div class="tabs"> <!-- wrapper for Produce Book -->
						...
						<div id="tabs-403">
							...
							?>
                                                        <?php
                                                        echo do_shortcode('[directory form="20" search="false" entry="false" entryonly="false" entryanchor="false" lightboxsettings="images,entry" showcount="false" thead="false" showrowids="false" jssearch="false" linkemail="false" linknewwindow="true" nofollowlinks="true" credit="false"]'); 
                                                        ?>
						...
						<div id="tabs-404">
							...
							?>
                                                        <?php
                                                        echo do_shortcode('[directory form="19" search="false" entry="false" entryonly="false" entryanchor="false" lightboxsettings="images,entry" showcount="false" thead="false" showrowids="false" jssearch="false" linkemail="false" linknewwindow="true" nofollowlinks="true" credit="false"]'); 
                                                        ?>
						</div>
