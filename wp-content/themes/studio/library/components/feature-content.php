...
<div id="content-blocks"><!-- start #content-blocks -->
	...
	<div class="content-block"><!-- start feature second block -->
		...
		<p>
			<?php if ($feature_blocktwo_image != ""){
				$img = '<img src="'.$feature_blocktwo_image.'" alt="'.$feature_blocktwo_image_title.'" class="alignleft"/>';
				echo $feature_blocktwo_link_title == '' ? $img : '<a href="'.$feature_blocktwo_link.'" title="'.$feature_blocktwo_link_title.'">'.$img.'</a>';
			} ?>
	...
	<div class="content-block-end"><!-- start feature third block -->
		...
		<p>
			<?php
			if ($feature_blockthree_image != ""){
				$img = '<img src="'.$feature_blockthree_image.'" alt="'.$feature_blockthree_image_title.'" class="alignleft"/>';
				echo $feature_blockthree_link_title == "" ? $img : '<a href="'.$feature_blockthree_link.'" title="'.$feature_blockthree_link_title.'">'.$img.'</a>';
			}
			?>
