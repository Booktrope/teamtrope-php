...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'studio' ),
		'accepted'          => __( 'Accepted', 'studio' ),
		'rejected'          => __( 'Rejected', 'studio' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'studio' ),
		'show_all'          => __( 'Show all', 'studio' ),
		'comments'          => __( 'comments', 'studio' ),
		'close'             => __( 'Close', 'studio' ),
		'view'              => __( 'View', 'studio' )
	);
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'studio' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
