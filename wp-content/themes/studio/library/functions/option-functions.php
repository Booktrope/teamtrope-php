...
$options = array (
	array("name" => __("Show custom header", 'studio'),
	    ...
	    "type" => "select",
		"std" => "Show",
		"options" => array(__("no", "studio"), __("yes", "studio"))),


	array(
			"name" => __("Show header image below main header?", 'studio'),
			"description" => __("If you select no, the header image will be placed as background of the main header, where the site title is.", 'studio'),
			"id" => $shortname . $shortprefix . "header_edit_img_on",
			"inblock" => "slideone",
			"type" => "select",
			"std" => "Select",
			"options" => array(__("yes", "studio"), __("no", "studio"))
		),
		...
		"inblock" => "slideone",
			...
			array(
				"name" => __("List latest posts ", 'studio'),
				"description" => __("List blog posts on the homepage after slider position.", 'studio'),
				"id" => $shortname . $shortprefix . "homepage_latest_posts",
				"inblock" => "slideone",
				"type" => "select",
				"std" => "no",
				"options" => array(__("no", "studio"), __("yes", "studio"))
...
function studio_admin_panel() {
	...
	<form action="" method="post">
	  ...
	  <ul class="ui-tabs-nav" id="tabm">
		...
		<input name="reset" type="submit" class="sbutton theme_reset_button" value="<?php echo esc_attr(__('Reset All Options','studio')); ?>" />
...
function studio_admin_head() { ?>
	...
	<?php wp_enqueue_script("jquery"); ?>
		...
		jQuery(document).ready(function($){
			...
			$('.theme_reset_button').click(function(e){
