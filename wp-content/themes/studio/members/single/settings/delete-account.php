	...
	<div id="content">
		<div class="padder">
			...
			<div id="item-body" role="main">
				...
				<h3><?php _e( 'Delete Account', 'studio' ); ?></h3>
				...
				<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
					...
					<div id="message" class="info">
						<p><?php _e( 'WARNING: Deleting your account will completely remove ALL content associated with it. There is no way back, please be careful with this option.', 'studio' ); ?></p>
					</div>
					...
					<div class="submit">
						<input type="submit" disabled="disabled" value="<?php _e( 'Delete My Account', 'studio' ) ?>" id="delete-account-button" name="delete-account-button" />
					</div>
