	...
	<div id="footer-wrapper"><!-- start #footer-wrapper -->
		<div id="footer"><!-- start #footer -->
			<div id="footer-links"><!-- start #footer-links-->
					...
					<a href="<?php echo get_option('home'); ?>"><?php _e( 'Copyright', 'studio' ) ?> &copy;<?php echo gmdate(__('Y')); ?> <?php bloginfo('name'); ?></a><a href="#site-wrapper"><?php _e('Go back to top &uarr;', 'studio'); ?></a>
					<?php if($bp_existed == 'true') : ?>
