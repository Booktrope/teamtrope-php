...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	...
	<body <?php body_class() ?>>
		...
		<?php endif; ?>
			...
			<?php endif; ?>
			<?php
			$customheader_on = get_option('dev_studio_customheader_on');
			$header_edit_img_on = get_option('dev_studio_header_edit_img_on');
			if ($customheader_on == "yes" && $header_edit_img_on !='no'){
			?>
